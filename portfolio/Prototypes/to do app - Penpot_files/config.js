var penpotFlags = "enable-audit-log enable-audit-log-archive enable-audit-log-gc enable-user-feedback enable-smtp disable-log-emails disable-backend-asserts disable-demo-users disable-telemetry enable-terms-and-privacy-checkbox enable-login-with-google enable-login-with-github enable-login-with-gitlab enable-newsletter-subscription enable-quotes enable-soft-quotes enable-webhooks enable-urepl-server enable-prepl-server enable-access-tokens enable-exporter-svgo enable-frontend-svgo enable-rpc-climit enable-file-validation enable-soft-file-schema-validation enable-feature-components-v2 enable-feature-styles-v2 enable-feature-grid-layout";
